...
//                    update.setTipoDePersona((persona.getTipoDePersona() == null) ? update.getTipoDePersona() : persona.getTipoDePersona());
                    update.setTipoDoc((persona.getTipoDoc() == null) ? update.getTipoDoc() : persona.getTipoDoc());
                    update.setAsistencia((persona.getAsistencia() == null) ? update.getAsistencia() : persona.getAsistencia());
                    update.setBday((persona.getBday() == null) ? update.getBday() : persona.getBday());
                    update.setEliminado((persona.getEliminado() == null) ? update.getEliminado() : persona.getEliminado());
                    em.merge(update);
                    transaction.commit();
                }
